...
<div class="evfwr-authorization-grid__visual">
	<div class="evfwr-authorization-grid__holder">
		<div class="evfwr-authorization-grid__inner">
			<div class="evfwr-authorization" style="background: <?php esc_html( get_option( 'evfwr_verification_popup_background_color', $evfwr_verification_widget_style->defaults['evfwr_verification_popup_background_color'] ) ); ?>;">				
				<form class="evfwr_pin_verification_form" method="post">    
					<section class="evfwr-authorization__holder">
						<div class="popup_image" style="width:<?php esc_html( $evfwr_widget_header_image_width ); ?>px;">	                                 
							<?php 
						...
						<div class="evfwr-authorization__heading">
							<span class="evfwr-authorization__title" style="font-size: <?php esc_html( $evfwr_button_text_header_font_size ); ?>px;">
								<?php 
						...
						<div class="evfwr-pin-verification">								
							<div class="evfwr-pin-verification__row">
								<div class="evfwr-field evfwr-field_size_extra-large evfwr-field_icon_left evfwr-field_event_right evfwr-field_text_center">
									<h5 class="required-filed"><?php esc_html( apply_filters( 'evfwr_verification_code_length', __( '4-digits code', 'customer-email-verification-for-woocommerce' ) ) ); ?>*</h5>
									<input class="evfwr_pin_box" id="evfwr_pin1" name="evfwr_pin1" type="text" placeholder="Enter <?php esc_html( apply_filters( 'evfwr_verification_code_length', __( '4-digits code', 'customer-email-verification-for-woocommerce' ) ) ); ?>">
								</div>
							</div>
							<div class="evfwr-pin-verification__failure js-pincode-invalid" style="display: none;">
								<div class="evfwr-alert evfwr-alert_theme_red">										
									<span class="js-pincode-error-message"><?php esc_html( 'Verification code does not match', 'customer-email-verification-for-woocommerce' ); ?></span>
								</div>
							</div>
							<div class="evfwr-pin-verification__events">
								...
								<button class="evfwr-button  evfwr-button_size_promo evfwr-button_type_block evfwr-pin-verification__button is-disabled" type="submit" style="background-color:<?php esc_html(  $evfwr_button_color_widget_header ); ?>; color:<?php esc_html( $evfwr_button_text_color_widget_header ); ?>; font-size:<?php esc_html( $evfwr_button_text_size_widget_header ); ?>px;" >
									<?php esc_html( 'Verify Code', 'customer-email-verification-for-woocommerce' ); ?><i class="evfwr-icon evfwr-icon_size_medium dmi-continue_arrow_24 evfwr-button__visual evfwr-button__visual_type_fixed"></i>
								</button>									
							</div>
						</div>
					</section>
...
<style>
	.evfwr-authorization-grid__visual{
		background-color: <?php esc_html( woo_customer_email_verification()->hex2rgba( $evfwr_verification_overlay_color, '0.7' ) ); ?>;	
	}	
	html { 
		background: none;
	}
